              ...
              StatefulShellRoute(
                ...
                branches: [
                  StatefulShellBranch(
                    routes: [
                      GoRoute(
                        name: Routes.awesomeShopSpecials(),
                        path: 'specials',
                        builder: (_, _) => AwesomeShopSpecialsDestination(),
                        routes: [
                          GoRoute(
                            parentNavigatorKey: _shopKey,
                            name: Routes.awesomeShopSpecialsDetail(),
                            path: ':id',
                  ...
                  StatefulShellBranch(
                    routes: [
                      GoRoute(
                        name: Routes.awesomeShopCustomizer(),
                        path: 'customizer',
                        builder: (_, _) => AwesomeShopCustomizerDestination(),
                        routes: [
                          GoRoute(
                            parentNavigatorKey: _shopKey,
                            name: Routes.awesomeShopCustomizerDetail(),
                            path: ':id',
                            builder: (_, state) => AwesomeShopDetailPage(
                              id: state.pathParameters['id']!,
                            ),
                  ...
                  StatefulShellBranch(
                    routes: [
                      GoRoute(
                        name: Routes.awesomeShopEquipment(),
                        path: 'equipment',
                        builder: (_, _) => AwesomeShopEquipmentDestination(),
                        routes: [
                          GoRoute(
                            parentNavigatorKey: _shopKey,
                            name: Routes.awesomeShopEquipmentDetail(),
                            path: ':id',
                            builder: (_, state) => AwesomeShopDetailPage(
                              id: state.pathParameters['id']!,
                            ),
