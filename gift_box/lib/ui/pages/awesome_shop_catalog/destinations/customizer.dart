...
class AwesomeShopCustomizerDestination
    extends AwesomeShopDestination<AwesomeShopItemMetasCustomizerBloc> {
  const AwesomeShopCustomizerDestination({super.key})
    : super(detailRoute: AppRoute.awesomeShopCustomizerDetail);
}
