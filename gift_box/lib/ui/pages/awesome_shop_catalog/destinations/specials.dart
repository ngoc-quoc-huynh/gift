...
class AwesomeShopSpecialsDestination
    extends AwesomeShopDestination<AwesomeShopItemMetasSpecialsBloc> {
  const AwesomeShopSpecialsDestination({super.key})
    : super(detailRoute: AppRoute.awesomeShopSpecialsDetail);
}
